...
import { MAX_IMAGE_UPLOAD_SIZE, validateImageFile } from "@/lib/cloudinaryUpload";

export const MAX_FILE_SIZE = MAX_IMAGE_UPLOAD_SIZE // 5MB
 ...
 */
export const handleImageUpload = async (file, onProgress, abortSignal, uploadHandler) => {
  ...
  return uploadHandler(file, onProgress, abortSignal)
}
